...
if not exist "%~dp0setup-langtechdepot.ps1" (
    echo setup-langtechdepot.ps1 is not in this folder, so there is nothing to run.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0setup-langtechdepot.ps1" -NoPause
